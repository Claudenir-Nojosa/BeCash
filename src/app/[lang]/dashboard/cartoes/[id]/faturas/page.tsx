      ...
      <div className="min-h-screen p-6 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="flex flex-col items-center justify-center h-72 text-center space-y-4"
          >
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{ delay: 0.2, type: "spring", stiffness: 200 }}
              className="p-4 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900"
            >
    ...
    <div className="min-h-screen p-3 sm:p-4 md:p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4 }}
          className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm"
        >
            ...
            <div className="flex-1 min-w-0">
              ...
              {cartao && (
                <motion.div
                  ...
                  className="flex items-center gap-1.5 sm:gap-2 mt-1"
                >
                  <div
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex flex-col items-center space-y-2 flex-1 mx-4">
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1 }}
                      transition={{ delay: 0.2 }}
                      className="flex items-center justify-between w-full max-w-md gap-2"
                    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <motion.div
            ...
            whileHover={{ y: -4 }}
          >
            <Card className="bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-blue-900/20 border-0 shadow-lg rounded-xl sm:rounded-2xl overflow-hidden group hover:shadow-xl transition-all duration-300">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-start justify-between mb-3 sm:mb-4">
                  <motion.div
                    ...
                    className="p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30"
                  >
          ...
          <motion.div
            ...
            whileHover={{ y: -4 }}
          >
            <Card className="bg-gradient-to-br from-white to-emerald-50 dark:from-gray-800 dark:to-emerald-900/20 border-0 shadow-lg rounded-xl sm:rounded-2xl overflow-hidden group hover:shadow-xl transition-all duration-300">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-start justify-between mb-3 sm:mb-4">
                  <motion.div
                    initial={{ scale: 0 }}
                    ...
                    className="p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-emerald-100 to-green-100 dark:from-emerald-900/30 dark:to-green-800/30"
                  >
                ...
                <Card className="bg-white dark:bg-gray-800/50 border-0 shadow-lg sm:shadow-xl rounded-lg sm:rounded-xl overflow-hidden">
                    ...
                    <div className="flex flex-col xs:flex-row items-start xs:items-center justify-between gap-2">
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        <motion.div
                          ...
                          className="p-1.5 rounded-lg bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 flex-shrink-0"
                        >
                  ...
                  <CardContent className="px-3 sm:px-4 md:px-6 pt-0">
                    <div className="space-y-2 sm:space-y-3">
                      {comprasParceladas.map((lancamento, index) => (
                        <motion.div
                          key={lancamento.id}
            ...
            {comprasNormais.length > 0 && (
              ...
              >
                <Card className="bg-white dark:bg-gray-800/50 border-0 shadow-lg sm:shadow-xl rounded-lg sm:rounded-xl overflow-hidden">
                  ...
                  <CardContent className="px-3 sm:px-4 md:px-6 pt-0">
                    <div className="space-y-2 sm:space-y-3">
                      {comprasNormais.map((lancamento, index) => (
                        <motion.div
                          key={lancamento.id}
                          initial={{ opacity: 0, x: -20 }}
                          animate={{ opacity: 1, x: 0 }}

// app/dashboard/lancamentos/despesas/page.tsx
"use client";
...
export default function DespesasPage() {
  ...
  const buscarDespesas = async () => {
    try {
      ...
      const toastId = toast.loading("Carregando despesas...");
      ...
      // Toast de sucesso
      toast.success("Despesas carregadas", {
        id: toastId,
        description: `${data.lancamentos.length} despesa(s) encontrada(s)`,
        duration: 3000,
      });
    } catch (error) {
  ...
  const atualizarStatusPagamento = async (id: string, pago: boolean) => {
    try {
      ...
      // Toast de sucesso
      toast.success(`Despesa ${pago ? "recebida" : "marcada como pendente"}`, {
        id: toastId,
  ...
  // Filtrar totais por categoria apenas para despesas
  const totaisDespesasPorCategoria = totaisPorCategoria.filter(
    ...
    <div className="container mx-auto p-6 mt-20">
      ...
      <Card className="mb-6">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" onClick={buscarDespesas}>
              Aplicar Filtros
            </Button>
          </div>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {lancamentosFiltrados.length} despesa(s) encontrada(s)
          </CardDescription>
        </CardHeader>
        <CardContent>
          {carregando ? (
      ...
      {totaisDespesasPorCategoria.length > 0 && (
        <Card className="mt-6">
          <CardHeader>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {totaisDespesasPorCategoria.map((item) => (
                <div
                  key={item.categoria}
